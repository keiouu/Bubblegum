...
if ($git_data && $project) {
	...
	print '<tbody><tr><td><span class="author"><img src="http://www.gravatar.com/avatar/'.$gravatar.'?s=22" alt="Profile Image" class="gravatar" />' . string_encode($git_data["author"]) . '</span> <span class="date">(' . $dateField->get_readable_value() . ')</span>';
