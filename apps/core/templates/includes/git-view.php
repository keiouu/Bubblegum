...
if ($git_data) {
	...
	print '<thead><tr><th><a href="'.$request->fullPath.'git/'.$git_data["hash"].'/">' . $git_data["message"] . '</a></th></tr></thead>';
	...
	print '<a href="'.$request->fullPath.'git/'.$git_data["hash"].'/" class="hash">' . ellipsize($git_data["hash"], 13) . '<i class="icon-share-alt"></i></a></td></tr></tbody>';
} else {
