<?php
/*
 * Tikapot Model Field init script
 * v1.0
 *
 */
...
include_once(home_dir . "framework/model_fields/filefield.php");
include_once(home_dir . "framework/model_fields/fkfield.php");
include_once(home_dir . "framework/model_fields/multifkfield.php");
include_once(home_dir . "framework/model_fields/keyfield.php");
include_once(home_dir . "framework/model_fields/m2mfield.php");
