...
<div class="debug_panel">
	...
	<div id="profile-tab" class="debug_tab">
		<div style="padding: 20px 30px;"><h3 style="color: #EEE;">{% i18n "debug_profiler" %}</h3>
		<?php
		require_once(home_dir . "framework/profiler.php");
		$blocks = Profiler::get_blocks();
		foreach ($blocks as $block_set) {
			foreach ($block_set as $block) {
				print '<p style="margin: 3px; color: #EEE;">' . $block . '</p>';
			}
		}
		?>
		</div>
